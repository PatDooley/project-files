...
create table User (
    ...
    name    varchar(256) NOT NULL,       -- NOt NULL makes this a required field for the table
...
-- ALTER will change the structure of a table without dropping or recreating it
...
create table Customer (  -- create a new table Customer
    ...
    -- (col-in-this-table)    parent-table(col-in-parent)     -should be primary key of the parent
...
insert into Customer
  (uid, address)
  select uid, 'Death Star' from User where name like '%Vader%'
;
